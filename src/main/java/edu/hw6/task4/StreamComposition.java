...
public class StreamComposition {
    ...
    public static void writeComposeStreams(Path file) {
        try (
            Writer writer = new PrintWriter(new OutputStreamWriter(new BufferedOutputStream(new CheckedOutputStream(newOutputStream(FILES.resolve(
                file)), new CRC32())), StandardCharsets.UTF_8))) {
