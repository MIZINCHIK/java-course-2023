...
public class LogTest {
    ...
    void parseLog_incorrectTime_optionalEmpty() {
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +18:30] \"Ddsfsdf /downloads/product_1 HTTP/1.1\" 304 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
        assertThat(parseLog("93.180.71.3 - - [17/10/2015:08:05:32 +0000] \"Ddsfsdf /downloads/product_1 HTTP/1.1\" 304 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
    ...
    void parseLog_correctTime_optionalEmpty() {
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 -0700] \"GET /downloads/product_1 HTTP/1.1\" 304 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")
    ...
    void parseLog_incorrectRequest_optionalEmpty() {
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"Ddsfsdf /downloads/product_1 HTTP/1.1\" 304 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
    }
    ...
    void parseLog_correctRequest_optionalEmpty() {
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")
    ...
    void parseLog_incorrectStatus_optionalEmpty() {
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 3043 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 30 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" -300 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
    }
    ...
    void parseLog_correctStatus_optionalEmpty() {
        ...
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 404 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")
            .get().code()).isEqualTo(404);
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 420 0 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")
    ...
    void parseLog_incorrectBytes_optionalEmpty() {
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 -1 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 asfdsadasd " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")).isEmpty();
    }
    ...
    void parseLog_correctBytes_optionalEmpty() {
        ...
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 404 100 " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")
            .get().bytesSent()).isEqualTo(100);
        assertThat(parseLog("93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 420 " + Long.MAX_VALUE + " " +
            "\"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"")
